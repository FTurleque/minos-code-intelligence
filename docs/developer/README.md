...
| `com.minos.store` | snapshots et persistance locale |
...
| `com.minos.api` | contrats Java publics M11/M12 |
...
| `com.minos.integration.nexus` | projection JSON vers NEXUS |
...
5. [Multi-dépôts et Git](multi-repo-git.md)
6. [Tests et contribution](testing.md)
