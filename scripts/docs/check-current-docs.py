...
def main() -> int:
    try:
        ...
        require_text("docs/STATUS.md", status, "S9   final production integrity gate                  VALIDÉ")
        ...
        require_text("docs/STATUS.md", status, "scripts/m21/run-s9.ps1")
        require_text("docs/STATUS.md", status, "M21 FINAL PRODUCTION INTEGRITY VALIDATION SUCCESS")
        require_text("docs/STATUS.md", status, "0ec50bedc8c49e45347309f406830089e8e84941")
        forbid_text("docs/STATUS.md", status, "S9   final production integrity gate                  EN COURS")
