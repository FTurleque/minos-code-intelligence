...
def main() -> int:
    try:
        ...
        require_text("docs/ROADMAP.md", roadmap, "M22 — Advanced Provider Intelligence")
        require_text("docs/ROADMAP.md", roadmap, "M22  Advanced Provider Intelligence               🚧 EN COURS")
        require_text("docs/ROADMAP.md", roadmap, "roadmap/M22_EXECUTION.md")
        require_text("docs/ROADMAP.md", roadmap, "ADR-0030")
        require_text("docs/ROADMAP.md", roadmap, "issue : #76")
        forbid_text("docs/ROADMAP.md", roadmap, "M22  Advanced Provider Intelligence               ⏳ PLANIFIÉ")
        forbid_text("docs/ROADMAP.md", roadmap, "Aucun M21 n'est déclaré")
        for milestone in range(23, 28):
            require_text("docs/ROADMAP.md", roadmap, f"M{milestone} —")

        require_text("docs/STATUS.md", status, "M21 — Production Integrity")
        require_text("docs/STATUS.md", status, "M22 — Advanced Provider Intelligence")
        ...
        require_text("docs/STATUS.md", status, "S7   advanced provider productionization              VALIDÉ")
        require_text("docs/STATUS.md", status, "S8   semantic scale qualification                     VALIDÉ")
        require_text("docs/STATUS.md", status, "S9   final production integrity gate                  VALIDÉ exact-head")
        require_text("docs/STATUS.md", status, "60c1aba43e2d005991152cc4f3fe0b0dadef1c2d")
        require_text("docs/STATUS.md", status, "4222706502c54e10f0bf0400a18360fb99e6208c")
        ...
        require_text("docs/STATUS.md", status, "57243384286ed623de2d9499c9ae6729f77f6845")
        require_text("docs/STATUS.md", status, "M21-S7 ADVANCED PROVIDER VALIDATION SUCCESS")
        require_text("docs/STATUS.md", status, "FileProgramGraphProvider")
        require_text("docs/STATUS.md", status, "M21-S8 SEMANTIC SCALE VALIDATION SUCCESS")
        require_text("docs/STATUS.md", status, "a668f0a09da08515396903fbe887ed9e70125201")
        require_text("docs/STATUS.md", status, "KEEP_CURRENT_M20_BACKEND")
        require_text("docs/STATUS.md", status, "M21 FINAL PRODUCTION INTEGRITY VALIDATION SUCCESS")
        require_text("docs/STATUS.md", status, "minos-java-source-v1")
        require_text("docs/STATUS.md", status, "precision=1.0 recall=1.0")
        ...
        require_text("docs/roadmap/M21_EXECUTION.md", execution, "S7 VALIDÉ")
        require_text("docs/roadmap/M21_EXECUTION.md", execution, "S8 VALIDÉ")
        require_text("docs/roadmap/M21_EXECUTION.md", execution, "S9 VALIDÉ")
        ...
        require_text("docs/roadmap/M21_EXECUTION.md", execution, "OPTIMIZE_MEASURED_BOTTLENECK")
        require_text("docs/roadmap/M21_EXECUTION.md", execution, "KEEP_CURRENT_M20_BACKEND")
        require_text("docs/roadmap/M21_EXECUTION.md", execution, "run-s9.ps1")
        require_text("docs/roadmap/M21_EXECUTION.md", execution, "M21 FINAL PRODUCTION INTEGRITY VALIDATION SUCCESS")
        require_text("docs/roadmap/M21_EXECUTION.md", execution, "0ec50bedc8c49e45347309f406830089e8e84941")
        forbid_text("docs/roadmap/M21_EXECUTION.md", execution, "S9 EN COURS")
        ...
        require_text("docs/roadmap/M22_EXECUTION.md", m22_execution, "M21-S2/CI reste en pause jusqu’en août 2026")
        ...
        require_text("scripts/quality/check-jacoco.py", quality_gate, "JavaSourceProgramGraphProvider")

        require_text("docs/developer/README.md", developer_readme, "semantic-scale-qualification.md")
        require_text("docs/developer/README.md", developer_readme, "java-advanced-provider.md")
        ...
        require_text("docs/developer/java-advanced-provider.md", java_advanced_provider, "precision=1.0 recall=1.0")
        require_text("docs/adr/0030-java-ast-reference-provider-with-explicit-capability-limits.md", m22_adr, "Status: **Accepted**")
        require_text("docs/adr/0030-java-ast-reference-provider-with-explicit-capability-limits.md", m22_adr, "guessed-classpath")
        ...
        forbid_text("scripts/m22/run-final.ps1", m22_runner, "workflow_dispatch")
        forbid_text("scripts/m22/run-final.ps1", m22_runner, "rerun_workflow")

        require_text("docs/developer/semantic-scale-qualification.md", semantic_scale, "Statut : **VALIDÉ le 28 juillet 2026**")
        ...
        require_text("docs/developer/semantic-scale-qualification.md", semantic_scale, "semantic-scale.progress.log")
        require_text("docs/developer/semantic-scale-qualification.md", semantic_scale, "Windows PowerShell 5.1")
        require_text("docs/developer/semantic-scale-qualification.md", semantic_scale, "a668f0a09da08515396903fbe887ed9e70125201")
        ...
        require_text("scripts/m21/M21SemanticScaleProbe.java", s8_probe, "M21-S8 PROGRESS")
        require_text("scripts/m21/M21SemanticScaleProbe.java", s8_probe, "semantic-scale.progress.log")
        ...
        require_text("scripts/m21/run-s8-benchmark.ps1", s8_benchmark, "benchmark_watchdog_minutes")
        require_text("scripts/m21/run-s8-benchmark.ps1", s8_benchmark, "WaitForExit(1000)")
        require_text("scripts/m21/run-s8-benchmark.ps1", s8_benchmark, "Stop-Process -Id $process.Id -Force")
        forbid_text("scripts/m21/run-s8-benchmark.ps1", s8_benchmark, "$process.Kill($true)")
        ...
        require_text("scripts/m21/run-s9.ps1", s9_runner, "run-s7.ps1")
        require_text("scripts/m21/run-s9.ps1", s9_runner, "run-s8.ps1")
        require_text("scripts/m21/run-s9.ps1", s9_runner, "run-s5.ps1")
        require_text("scripts/m21/run-s9.ps1", s9_runner, "run-s6.ps1")
        require_text("scripts/m21/run-s9.ps1", s9_runner, "KEEP_CURRENT_M20_BACKEND")
        require_text("scripts/m21/run-s9.ps1", s9_runner, "M21 FINAL PRODUCTION INTEGRITY VALIDATION SUCCESS")
        forbid_text("scripts/m21/run-s9.ps1", s9_runner, "rerun_workflow")
        forbid_text("scripts/m21/run-s9.ps1", s9_runner, "workflow_dispatch")
