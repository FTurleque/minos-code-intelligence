...
def main() -> int:
    try:
        ...
        require_text("docs/STATUS.md", status, "S8   semantic scale qualification                     EN COURS")
        ...
        require_text("docs/roadmap/M21_EXECUTION.md", execution, "S8 EN COURS")
        ...
        require_text("scripts/m21/run-s8.ps1", s8_runner, "BenchmarkTimeoutMinutes")
