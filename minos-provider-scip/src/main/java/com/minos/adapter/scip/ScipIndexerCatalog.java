...
public final class ScipIndexerCatalog {
    ...
    public static final String RUST_ANALYZER_SCIP_VERSION = "0.3.2989";
    public static final String RUST_ANALYZER_SCIP_RELEASE = "2026-07-27";
    public static final String RUST_ANALYZER_SCIP_COMMIT = "12c3381";
    ...
    /** Historical M17 catalog preserved for exact regression replays. */
    ...
    public static IndexerDescriptor scipJava() {
        return new IndexerDescriptor(
                "scip-java", "0.13.1", "scip-java",
                Set.of(Language.JAVA, Language.KOTLIN), Set.of(BuildSystem.MAVEN),
                Set.of(
    ...
    public static IndexerDescriptor scipTypeScript() {
        return new IndexerDescriptor(
                "scip-typescript", "0.4.0", "scip-typescript",
                Set.of(Language.TYPESCRIPT), Set.of(),
                Set.of(
                        IndexerCapability.SYMBOLS,
                        IndexerCapability.STABLE_SYMBOL_IDENTITY,
                        IndexerCapability.REFERENCES,
    ...
    public static IndexerDescriptor scipPython() {
        return new IndexerDescriptor(
                "scip-python", SCIP_PYTHON_VERSION, "scip-python",
                Set.of(Language.PYTHON), Set.of(),
                Set.of(
                        IndexerCapability.SYMBOLS,
                        IndexerCapability.REFERENCES,
                        IndexerCapability.TEST_SOURCES,
    ...
    public static IndexerDescriptor scipClang() {
        return new IndexerDescriptor(
                SCIP_CLANG_ID, SCIP_CLANG_VERSION, "scip-clang",
                Set.of(Language.C, Language.CPP), Set.of(BuildSystem.CMAKE),
                Set.of(
                        IndexerCapability.SYMBOLS,
                        IndexerCapability.STABLE_SYMBOL_IDENTITY,
                        IndexerCapability.REFERENCES,
    ...
    public static IndexerDescriptor scipDotnet() {
        return new IndexerDescriptor(
                SCIP_DOTNET_ID, SCIP_DOTNET_VERSION, "scip-dotnet",
                Set.of(Language.CSHARP), Set.of(BuildSystem.DOTNET),
                Set.of(
                        IndexerCapability.SYMBOLS,
                        IndexerCapability.STABLE_SYMBOL_IDENTITY,
                        IndexerCapability.REFERENCES,
    ...
    public static IndexerDescriptor scipGo() {
        return new IndexerDescriptor(
                SCIP_GO_ID, SCIP_GO_VERSION, "scip-go",
                Set.of(Language.GO), Set.of(BuildSystem.GO_MODULE),
                Set.of(
                        IndexerCapability.SYMBOLS,
                        IndexerCapability.STABLE_SYMBOL_IDENTITY,
                        IndexerCapability.REFERENCES,
    ...
    public static IndexerDescriptor rustAnalyzerScip() {
        return new IndexerDescriptor(
                RUST_ANALYZER_SCIP_ID, RUST_ANALYZER_SCIP_VERSION, "rust-analyzer scip",
                Set.of(Language.RUST), Set.of(BuildSystem.CARGO),
                Set.of(
                        IndexerCapability.SYMBOLS,
                        IndexerCapability.STABLE_SYMBOL_IDENTITY,
                        IndexerCapability.REFERENCES,
    ...
    public static ProviderCapabilityProfile scipClangProfile() {
        return polyglotProfile(scipClang(), CapabilitySupportLevel.PARTIAL, CapabilitySupportLevel.EXPERIMENTAL,
                CapabilitySupportLevel.PARTIAL, CapabilitySupportLevel.PARTIAL, CapabilitySupportLevel.UNSUPPORTED);
    }

    public static ProviderCapabilityProfile scipDotnetProfile() {
        return polyglotProfile(scipDotnet(), CapabilitySupportLevel.PARTIAL, CapabilitySupportLevel.PARTIAL,
                CapabilitySupportLevel.PARTIAL, CapabilitySupportLevel.EXPERIMENTAL, CapabilitySupportLevel.FULL);
    }

    public static ProviderCapabilityProfile scipGoProfile() {
        return polyglotProfile(scipGo(), CapabilitySupportLevel.PARTIAL, CapabilitySupportLevel.EXPERIMENTAL,
                CapabilitySupportLevel.PARTIAL, CapabilitySupportLevel.EXPERIMENTAL, CapabilitySupportLevel.FULL);
    }

    public static ProviderCapabilityProfile rustAnalyzerScipProfile() {
        return polyglotProfile(rustAnalyzerScip(), CapabilitySupportLevel.PARTIAL, CapabilitySupportLevel.EXPERIMENTAL,
                CapabilitySupportLevel.PARTIAL, CapabilitySupportLevel.EXPERIMENTAL, CapabilitySupportLevel.UNSUPPORTED);
    }

    private static ProviderCapabilityProfile polyglotProfile(
            IndexerDescriptor descriptor,
            CapabilitySupportLevel relationshipSupport,
            CapabilitySupportLevel multiModuleSupport,
            CapabilitySupportLevel testSupport,
            CapabilitySupportLevel partialFailureSupport,
            CapabilitySupportLevel runtimeInstallSupport
    ) {
        return profile(descriptor, Map.ofEntries(
                entry(IndexerCapability.SYMBOLS, CapabilitySupportLevel.FULL),
                entry(IndexerCapability.STABLE_SYMBOL_IDENTITY, CapabilitySupportLevel.PARTIAL),
                entry(IndexerCapability.REFERENCES, CapabilitySupportLevel.FULL),
                entry(IndexerCapability.UNRESOLVED_REFERENCES, CapabilitySupportLevel.PARTIAL),
                entry(IndexerCapability.IMPLEMENTATION_RELATIONS, relationshipSupport),
                entry(IndexerCapability.STRUCTURAL_RELATIONS, relationshipSupport),
                entry(IndexerCapability.CALL_RELATIONS, CapabilitySupportLevel.UNSUPPORTED),
                entry(IndexerCapability.MULTI_MODULE, multiModuleSupport),
                entry(IndexerCapability.TEST_SOURCES, testSupport),
    ...
    private static ProviderOperationalProfile scipJavaOperationalProfile() {
        return operational(
                scipJava(), Set.of(ProviderPlatform.WINDOWS_X64),
    ...
    private static ProviderOperationalProfile scipTypeScriptOperationalProfile() {
        return operational(
                scipTypeScript(), Set.of(ProviderPlatform.WINDOWS_X64), List.of("Node.js", "npm"),
    ...
    private static ProviderOperationalProfile scipPythonOperationalProfile() {
        return operational(
                scipPython(), Set.of(ProviderPlatform.WINDOWS_X64), List.of("Node.js 16+", "npm", "Python 3.10+", "pip"),
    ...
    private static ProviderOperationalProfile rustAnalyzerScipOperationalProfile() {
        return operational(
                ...
                "Origin must record rust-analyzer-scip 0.3.2989/index-run and preserve each raw SCIP symbol");
    }
    ...
    private static ProviderOperationalProfile operational(
        ...
        return new ProviderOperationalProfile(
                descriptor.id(), true, qualificationPlatforms, requirements,
                readiness, installation, stableIdentity, provenance);
    }
